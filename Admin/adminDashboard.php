...
<div class="col-sm-9 mt-5">
    ...
    <div class="mx-5 mt-5 text-center">
        <!--Table-->
        <p class="bg-dark p-2 text-white">Course Ordered</p>
        <?php
        $sql = "SELECT * FROM  courseorder";
        $result = $conn->query($sql);
        if ($result->num_rows > 0) {
            ...
            <thead>
                <tr>
                    <th scole="col">Order ID</th>
                    <th scole="col">Course ID</th>
                    <th scole="col">Student Email</th>
                    <th scole="col">Order Date</th>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td><form action="" method="POST" class="d-inline"><input type="hidden" name="id" value="' . $row["co_id"] . '><button type="submit" class="btn btn-secondary" name="delete" value="Delete"><i
