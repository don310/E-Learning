...
<div class="col-sm-6 mt-5">
    <form class="mt-5 mx-5">
        <div class="form-group mt-3">
            ...
            <input type="email" class="form-control mt-2" id="inputEmail" name="inputEmail" value="<?php echo $adminEmail;
            ?>" readonly>
        </div>
        <div class="form-group mt-3">
            <label for="inputnewpassword">New Password:</label>
            <input type="password" class="form-control  mt-2" id="inputnewpassword" name="adminPass" placeholder="New Password">
        </div>
        <div>
